...
// Login del staff para sellar visitas. Usa las mismas cuentas de la tabla
// `admins` que ya existen en el panel principal — no se pueden crear cuentas
// nuevas desde aquí, solo iniciar sesión con una ya existente.
