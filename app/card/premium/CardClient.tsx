...
// esa respuesta volvía. Ahora el <img> va en el HTML inicial.
export function CardPremiumClient({ initialCfg }: { initialCfg: PremiumConfig }) {
  ...
  const [cfg] = useState<PremiumConfig>(initialCfg)
