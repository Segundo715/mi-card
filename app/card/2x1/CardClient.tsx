...
// La marca (cfg) llega ya resuelta desde el Server Component (page.tsx) — antes se pedía con un
...
// client-side es el cliente ya registrado (localStorage, no accesible desde el servidor).
export function Card2x1Client({ initialCfg }: { initialCfg: PromoConfig }) {
  ...
  const [cfg] = useState<PromoConfig>(initialCfg)
