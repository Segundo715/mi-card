...
// Editor de las categorías de reward (café, 2x1, descuento, premium) que consumen
// /card, /card/2x1, /card/descuento y /card/premium. Se persiste en settings
// (reward_categories) — mismo formato que usa mi-menu.
...
const CARD_URLS: Record<string, string> = {
  cafe: '/card', dosxuno: '/card/2x1', descuento: '/card/descuento', premium: '/card/premium',
}
